...
//	nextBal := man.Balloter.GetNextProposingBal(pbk.MaxKnownBal.Number)
...
//}
//
//func (man *SimpleInstanceManager) HandleReceivedBallot(pbk *ProposingBookkeeping, inst int32, ballot stdpaxosproto.Ballot, phase stdpaxosproto.Phase) bool {
...
//}
//
//func (man *SimpleInstanceManager) HandleProposalChosen(pbk *ProposingBookkeeping, inst int32, ballot stdpaxosproto.Ballot) {
//	if pbk.Status == CLOSED {
//		return
//	}
//
...
//}
//
//func (man *MinimalProposersInstanceManager) HandleReceivedBallot(pbk *ProposingBookkeeping, inst int32, ballot stdpaxosproto.Ballot, phase stdpaxosproto.Phase) bool {
//	man.minimalProposersLearnOfBallot(ballot, inst)
//	return man.SimpleInstanceManager.HandleReceivedBallot(pbk, inst, ballot, phase)
//}
//
//func (man *MinimalProposersInstanceManager) HandleProposalChosen(pbk *ProposingBookkeeping, inst int32, ballot stdpaxosproto.Ballot) {
//	man.MinimalProposersShouldMaker.Cleanup(inst)
//	man.SimpleInstanceManager.HandleProposalChosen(pbk, inst, ballot)
//}
//
//func (man *MinimalProposersInstanceManager) minimalProposersLearnOfBallot(ballot stdpaxosproto.Ballot, inst int32) {

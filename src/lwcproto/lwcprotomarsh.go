...
func (t *Prepare) Unmarshal(wire io.Reader) error {
	...
	t.Ballot.Number = int16((uint16(bs[12]) | (uint16(bs[13]) << 8)))
	t.Ballot.PropID = int16((uint16(bs[14]) | (uint16(bs[15]) << 8)))
	return nil
}
...
func (t *PrepareReply) Marshal(wire io.Writer) {
	...
	bs[6] = byte(tmp32 >> 16)
	bs[7] = byte(tmp32 >> 24)
	tmp16 := t.ConfigBal.Ballot.Number
	bs[8] = byte(tmp16)
	bs[9] = byte(tmp16 >> 8)
	...
	bs[14] = byte(tmp32 >> 16)
	bs[15] = byte(tmp32 >> 24)
	tmp16 = t.VConfigBal.Ballot.Number
	bs[16] = byte(tmp16)
	bs[17] = byte(tmp16 >> 8)
...
func (t *PrepareReply) Unmarshal(rr io.Reader) error {
	...
	t.ConfigBal.Number = int16((uint16(bs[8]) | (uint16(bs[9]) << 8)))
	t.ConfigBal.PropID = int16((uint16(bs[10]) | (uint16(bs[11]) << 8)))

	t.VConfigBal.Config = int32((uint32(bs[12]) | (uint32(bs[13]) << 8) | (uint32(bs[14]) << 16) | (uint32(bs[15]) << 24)))
	t.VConfigBal.Number = int16((uint16(bs[16]) | (uint16(bs[17]) << 8)))
	t.VConfigBal.PropID = int16((uint16(bs[18]) | (uint16(bs[19]) << 8)))

	t.AcceptorId = int32((uint32(bs[20]) | (uint32(bs[21]) << 8) | (uint32(bs[22]) << 16) | (uint32(bs[23]) << 24)))
...
func (t *Accept) Unmarshal(rr io.Reader) error {
	...
	t.Instance = int32((uint32(bs[4]) | (uint32(bs[5]) << 8) | (uint32(bs[6]) << 16) | (uint32(bs[7]) << 24)))
	t.Config = int32((uint32(bs[8]) | (uint32(bs[9]) << 8) | (uint32(bs[10]) << 16) | (uint32(bs[11]) << 24)))
	t.Number = int16((uint16(bs[12]) | (uint16(bs[13]) << 8)))
	t.PropID = int16((uint16(bs[14]) | (uint16(bs[15]) << 8)))
...
func (t *AcceptReply) Unmarshal(wire io.Reader) error {
	...
	t.Cur.Number = int16((uint16(bs[12]) | (uint16(bs[13]) << 8)))
	t.Cur.PropID = int16((uint16(bs[14]) | (uint16(bs[15]) << 8)))

	t.Req.Config = int32((uint32(bs[16]) | (uint32(bs[17]) << 8) | (uint32(bs[18]) << 16) | (uint32(bs[19]) << 24)))
	t.Req.Number = int16((uint16(bs[20]) | (uint16(bs[21]) << 8)))
...
func (t *CommitShort) Unmarshal(wire io.Reader) error {
	...
	t.Config = int32((uint16(bs[12]) | (uint16(bs[13]) << 8)))
	t.Number = int16((uint16(bs[14]) | (uint16(bs[15]) << 8)))
	return nil
}

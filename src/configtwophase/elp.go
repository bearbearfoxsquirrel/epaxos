...
//}
//
//func (r *ELPReplica) replyPrepare(replicaId int32, reply *lwcproto.ConfigPrepareReply) {
//	r.SendMsg(replicaId, r.prepareReplyRPC, reply)
//}
//
//func (r *ELPReplica) replyAccept(replicaId int32, reply *lwcproto.ConfigAcceptReply) {
...
//}
//
//func (r *ELPReplica) checkAndHandleCatchUpRequest(prepare *lwcproto.ConfigPrepare) bool {
...
//}
//
//func (r *ELPReplica) checkAndHandleCatchUpResponse(commit *lwcproto.ConfigCommit) {
//	if r.catchingUp {
...
//			log.Printf("Received ConfigPrepare from replica %d, for instance %d\n", prepare.LeaderId, prepare.Instance)
...
//			log.Printf("Received ConfigAccept Request from replica %d, for instance %d\n", accept.LeaderId, accept.Instance)
...
//			log.Printf("Received ConfigPrepareReply for instance %d\n", prepareReply.Instance)
//			r.handlePrepareReply(prepareReply)
//			break
//		case acceptReplyS := <-r.acceptReplyChan:
//			acceptReply := acceptReplyS.(*lwcproto.ConfigAcceptReply)
//			//got an ConfigAccept reply
//			log.Printf("Received ConfigAcceptReply for instance %d\n", acceptReply.Instance)
...
//}
//
//func (r *ELPReplica) proposerCheckAndHandlePreempt(inst int32, preemptingConfigBal lwcproto.ConfigBal, preempterPhase Phase) bool {
...
//		r.BackoffManager.CheckAndHandleBackoff(inst, pbk.propCurConfBal, preemptingConfigBal, preempterPhase)
//		//	}
//
...
//}
//
//func (r *ELPReplica) handlePrepare(prepare *lwcproto.ConfigPrepare) {
...
//}
//
//func (r *ELPReplica) handlePrepareReply(preply *lwcproto.ConfigPrepareReply) {
...
//}
//
//func (r *ELPReplica) handleAccept(accept *lwcproto.ConfigAccept) {
...
//}
//
//func (r *ELPReplica) handleAcceptReply(areply *lwcproto.ConfigAcceptReply) {
...
//}
//
//func (r *ELPReplica) handleCommit(commit *lwcproto.ConfigCommit) {
...
//}
//
//func (r *ELPReplica) handleCommitShort(commit *lwcproto.ConfigCommitShort) {
//	r.checkAndHandleNewlyReceivedInstance(commit.Instance)
//	inst := r.instanceSpace[commit.Instance]
//
//	if inst.abk.status == COMMITTED {

...
//}
//
//func (r *LWPReplica) replyPrepare(replicaId int32, reply *lwcproto.ConfigPrepareReply) {
//	r.SendMsg(replicaId, r.prepareReplyRPC, reply)
//}
//
//func (r *LWPReplica) replyAccept(replicaId int32, reply *lwcproto.ConfigAcceptReply) {
...
//}
//
//func (r *LWPReplica) checkAndHandlecatchupRequest(prepare *lwcproto.ConfigPrepare) bool {
...
//func (r *LWPReplica) checkAndHandlecatchupResponse(commit *lwcproto.ConfigCommit) {
//	if r.catchingUp {
...
//}
//
//func (r *LWPReplica) handlePrepare(prepare *lwcproto.ConfigPrepare) {
...
//}
//
//func (r *LWPReplica) handlePrepareReply(preply *lwcproto.ConfigPrepareReply) {
...
//}
//
//func (r *LWPReplica) handleAccept(accept *lwcproto.ConfigAccept) {
...
//}
//
//func (r *LWPReplica) handleAcceptReply(areply *lwcproto.ConfigAcceptReply) {
...
//}
//
//func (r *LWPReplica) handleCommit(commit *lwcproto.ConfigCommit) {
...
//}
//
//func (r *LWPReplica) handleCommitShort(commit *lwcproto.ConfigCommitShort) {
//	r.checkAndHandleNewlyReceivedInstance(commit.Instance)
//	inst := r.instanceSpace[commit.Instance]
//
//	if inst.abk.status == COMMITTED {

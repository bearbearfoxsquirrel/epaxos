...
//
//	r.prepareRPC = r.RegisterRPC(new(lwcproto.ConfigPrepare), r.prepareChan)
//	r.acceptRPC = r.RegisterRPC(new(lwcproto.ConfigAccept), r.acceptChan)
//	r.commitRPC = r.RegisterRPC(new(lwcproto.ConfigCommit), r.commitChan)
//	r.commitShortRPC = r.RegisterRPC(new(lwcproto.ConfigCommitShort), r.commitShortChan)
//	r.prepareReplyRPC = r.RegisterRPC(new(lwcproto.ConfigPrepareReply), r.prepareReplyChan)
//	r.acceptReplyRPC = r.RegisterRPC(new(lwcproto.ConfigAcceptReply), r.acceptReplyChan)
//
//	if cmpComitExec {
...
//}
//
//func (r *Replica) replyPrepare(replicaId int32, reply *lwcproto.ConfigPrepareReply) {
//	r.SendMsg(replicaId, r.prepareReplyRPC, reply)
//}
//
//func (r *Replica) replyAccept(replicaId int32, reply *lwcproto.ConfigAcceptReply) {
...
//}
//
//func (r *Replica) checkAndHandleCatchUpRequest(prepare *lwcproto.ConfigPrepare) bool {
...
//func (r *Replica) checkAndHandleCatchUpResponse(commit *lwcproto.ConfigCommit) {
//	if r.catchingUp {
...
//			prepare := prepareS.(*lwcproto.ConfigPrepare)
//			//got a ConfigPrepare message
//			dlog.Printf("Received ConfigPrepare from replica %d, for instance %d\n", prepare.LeaderId, prepare.Instance)
//			if !r.checkAndHandleCatchUpRequest(prepare) {
//				r.handlePrepare(prepare)
//			}
//			break
//		case acceptS := <-r.acceptChan:
//			accept := acceptS.(*lwcproto.ConfigAccept)
//			//got an ConfigAccept message
//			dlog.Printf("Received ConfigAccept Request from replica %d, for instance %d\n", accept.LeaderId, accept.Instance)
//			r.handleAccept(accept)
//			break
//		case commitS := <-r.commitChan:
//			commit := commitS.(*lwcproto.ConfigCommit)
//			//got a ConfigCommit message
//			dlog.Printf("Received ConfigCommit from replica %d, for instance %d\n", commit.LeaderId, commit.Instance)
//			r.handleCommit(commit)
//			r.checkAndHandleCatchUpResponse(commit)
//			break
//		case commitS := <-r.commitShortChan:
//			commit := commitS.(*lwcproto.ConfigCommitShort)
//			//got a ConfigCommit message
//			dlog.Printf("Received short ConfigCommit from replica %d, for instance %d\n", commit.LeaderId, commit.Instance)
//			r.handleCommitShort(commit)
//			break
//		case prepareReplyS := <-r.prepareReplyChan:
//			prepareReply := prepareReplyS.(*lwcproto.ConfigPrepareReply)
//			//got a ConfigPrepare reply
//			dlog.Printf("Received ConfigPrepareReply for instance %d\n", prepareReply.Instance)
//			r.handlePrepareReply(prepareReply)
//			break
//		case acceptReplyS := <-r.acceptReplyChan:
//			acceptReply := acceptReplyS.(*lwcproto.ConfigAcceptReply)
//			//got an ConfigAccept reply
//			dlog.Printf("Received ConfigAcceptReply for instance %d\n", acceptReply.Instance)
...
//			dlog.Println("ConfigPrepare bcast failed:", err)
//		}
//	}()
//	args := &lwcproto.ConfigPrepare{r.Id, instance, r.instanceSpace[instance].pbk.propCurConfBal}
...
//}
//
//var pa lwcproto.ConfigAccept
//
//func (r *Replica) bcastAcceptToAll(instance int32) {
//	defer func() {
//		if err := recover(); err != nil {
//			dlog.Println("ConfigAccept bcast failed:", err)
//		}
//	}()
//
//	pa.LeaderId = r.Id
...
//}
//
//var pc lwcproto.ConfigCommit
//var pcs lwcproto.ConfigCommitShort
//
...
//}
//
//func (r *Replica) handlePrepare(prepare *lwcproto.ConfigPrepare) {
...
//	}
//
//	var preply = &lwcproto.ConfigPrepareReply{
...
//		preemptOldPropMsg := &lwcproto.ConfigPrepareReply{
//			Instance:   inst,
//			ConfigBal:  new,
//			VConfigBal: accepted,
...
//}
//
//func (r *Replica) handlePrepareReply(preply *lwcproto.ConfigPrepareReply) {
...
//		myReply := lwcproto.ConfigPrepareReply{
...
//}
//
//func (r *Replica) handleAccept(accept *lwcproto.ConfigAccept) {
...
//	}
//
//	areply := &lwcproto.ConfigAcceptReply{accept.Instance, r.Id, replyConfBal, accept.ConfigBal, inst.pbk.whoseCmds}
//	r.replyAccept(accept.LeaderId, areply)
//}
//
//func (r *Replica) checkAndOpenNewInstances() {
...
//	for r.crtInstance-r.executedUpTo < r.maxOpenInstances {
//		r.beginNextInstance()
//	}
//	//	}
//	//}
//}
//
//func (r *Replica) handleAcceptReply(areply *lwcproto.ConfigAcceptReply) {
...
//}
//
//func (r *Replica) handleCommit(commit *lwcproto.ConfigCommit) {
...
//}
//
//func (r *Replica) handleCommitShort(commit *lwcproto.ConfigCommitShort) {
//	r.checkAndHandleNewlyReceivedInstance(commit.Instance)
//	inst := r.instanceSpace[commit.Instance]
//
//	if inst.abk.status == COMMITTED {
